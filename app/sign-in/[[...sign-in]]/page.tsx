            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  <p>Your account does not have access to Lumyn Payroll. Please contact your administrator or <a href="mailto:support@lumyn.com" className="font-medium underline hover:text-red-600">support@lumyn.com</a> for assistance.</p>
                </div>
              </div>
            </div>
          </div>
